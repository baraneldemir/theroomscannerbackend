...
const scrapeImages = async (location) => {
    const results = { images: [], prices: [], titles: [], links: [], listingLocations: [], description: [] };
    ...
    try {
        ...
        await page.goto(searchURL, { waitUntil: 'networkidle2', timeout: 500000 });
        await page.waitForSelector('figure img', { visible: true, timeout: 500000 });
